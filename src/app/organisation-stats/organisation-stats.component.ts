...
export class OrganisationStatsComponent implements OnInit, OnDestroy {
  ...
  private roots: am5.Root[] = []; // To hold multiple root elements
  private charts: am5percent.PieChart[] = []; // To hold multiple charts
  ...
  ngOnInit(): void {
    ...
    for (let i = 1; i <= 6; i++) {
      ...
      const series0 = chart.series.push(am5percent.PieSeries.new(root, {
        valueField: "bottles",
        categoryField: "country",
        alignLabels: false
      }));
